...
namespace log4net.Tests
{
    ...
    public class Utils
    {
...
#else
            var m = target.GetType().GetMethod(name, GetTypesArray(args));
            if (m == null) m = target.GetType().GetMethod(name, BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Static | BindingFlags.Instance);
...
#else
            var m = target.GetMethod(name, GetTypesArray(args));
            if (m == null) m = target.GetMethod(name, BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Static | BindingFlags.Instance);
        ...
        {
            var f = target.GetType().GetField(name, BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Static | BindingFlags.Instance).GetValue(target);
            return f;
        }
